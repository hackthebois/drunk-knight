...
const CardItem = ({ card }: { card?: Card }) => {
	...
	return (
		<div className="w-full h-full text-text flex flex-col shadow overflow-y-auto overflow-x-hidden">
			<div
			...
			<div className="bg-white p-3 sm:p-6 flex-1 rounded-b">
				<h3 className="text-2xl sm:text-4xl font-bold text-left break-word">
					{name}
				</h3>
